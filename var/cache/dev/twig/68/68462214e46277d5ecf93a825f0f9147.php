...
class __TwigTemplate_6e5e748406defd86b6ad16ca79c2631c extends Template
{
        ...
        <div class=\"metric-group\">
            ...
            <div class=\"metric\">
                    <span class=\"value\">
                        ";
            // line 172
            yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["pool"] ?? null), "hit_read_ratio", [], "any", true, true, false, 172) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["pool"] ?? null), "hit_read_ratio", [], "any", true, true, false, 172)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["pool"] ?? null), "hit_read_ratio", [], "any", false, false, false, 172), "html", null, true)) : (0));
...
{% endmacro %}
", "@WebProfiler/Collector/cache.html.twig", "C:\\Users\\danie\\nico_artpage\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\cache.html.twig");
    }
}
